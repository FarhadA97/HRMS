    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, bcryptjs_1.default.compare(password, oldUser.password)];
            case 3:
                isPasswordCorrect = _b.sent();
                if (!isPasswordCorrect)
                    return [2 /*return*/, res.status(400).json({ message: "Invalid Password" })];
                token = jsonwebtoken_1.default.sign({ email: oldUser.email, id: oldUser._id }, config_1.secret, { expiresIn: "1h" });
...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, name, oldUser, hashedPassword, result, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 3:
                ...
                return [4 /*yield*/, User_1.default.create({ email: email, password: hashedPassword, name: name })];
            case 4:
                result = _b.sent();
                token = jsonwebtoken_1.default.sign({ email: result.email, id: result._id }, config_1.secret, { expiresIn: "1h" });
