    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                token = jsonwebtoken_1.default.sign({ email: oldUser.email, id: oldUser._id }, secret, { expiresIn: "1h" });
...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                result = _b.sent();
                token = jsonwebtoken_1.default.sign({ email: result.email, id: result._id }, secret, { expiresIn: "1h" });
